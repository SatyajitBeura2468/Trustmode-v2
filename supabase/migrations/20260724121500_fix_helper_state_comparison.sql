-- PostgreSQL resolves jsonb - array[...] ambiguously on this project version.
-- Remove allowed volatile keys explicitly before comparing helper-controlled state.
...
begin
  ...
  if (candidate - 'proposalRecords' - 'events' - 'revision' - 'updatedAt' - 'lastActiveAt')
       is distinct from
     (stored.state - 'proposalRecords' - 'events' - 'revision' - 'updatedAt' - 'lastActiveAt') then
