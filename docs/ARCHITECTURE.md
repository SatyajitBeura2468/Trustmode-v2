...
TrustMode v2.2 is a controlled shared-session product with a plain-language shared-form owner experience, a matching helper route, controlled fictional portals, a Manifest V3 portal adapter, a Supabase Postgres capability service, and a shared TypeScript domain engine.
